<div class="content">
 <div class="intro-y flex flex-col sm:flex-row items-center mt-8">
  ...
  <div class="w-full sm:w-auto flex mt-4 sm:mt-0">
   ...
   <div class="text-center"> <a href="<?= base_url('admin/cetakGuru') ?>" class="button text-white bg-theme-9 shadow-md mr-2 mt-10">Cetak Data</a></div>
   ...
   <tbody>
    ...
    foreach ($master as $row) : ?>
     <tr>
      ...
      <td class="text-center border-b"><?= $row['nip'] ?></td>
 ...
 <div class="modal__content">
  ...
  <form action="" method="post">
   ...
   <div class="p-5 grid grid-cols-12 gap-4 row-gap-3">
    ...
    <div class="col-span-12 sm:col-span-6"> <label>Nip</label> <input type="text" class="input w-full border mt-2 flex-1" placeholder="nip" name="nip"> </div>
...
<?php foreach ($master as $row) : ?>
 <div class="modal" id="edit-modal-preview<?= $row['id_user'] ?>">
  <div class="modal__content">
   ...
   <form action="<?= base_url('admin/updateMaster/guru') ?>" method="post">
    <input type="hidden" name="level" value="Guru">
    ...
    <div class="p-5 grid grid-cols-12 gap-4 row-gap-3">
     ...
     <div class="col-span-12 sm:col-span-6"> <label>Nip</label> <input type="text" class="input w-full border mt-2 flex-1" placeholder="nip" name="nip" value="<?= $row['nip'] ?>"> </div>
 ...
 <div class="modal" id="delete-modal-preview<?= $row['id_user'] ?>">
  <div class="modal__content">
   ...
   <div class="px-5 pb-8 text-center"> <button type="button" data-dismiss="modal" class="button w-24 border text-gray-700 mr-1">Cancel</button>
    <a href=" <?= base_url('admin/deleteMaster/guru/') . $row['id_user'] ?>" class=" button w-24 bg-theme-6 text-white">Hapus</a>
   </div>
  </div>
 <?php endforeach; ?>